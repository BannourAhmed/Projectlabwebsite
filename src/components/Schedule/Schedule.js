...
export const Schedule = () => {
  ...
  return (
    <section className="schedule" id="deliverables">
      <Container>
        <Row>
          <Col size={12}>
            <TrackVisibility>
...
<br/>Required length: 6-7 double-column pages (for teams of 2 students)
...
<ul>
  ...
  <li><h6> It is possible to add a max 10-page-long supplementary material with additional tables,
