    ...
    <section className="history" id="history">
      <Container className="cont1">
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}> 
           <span className="tagline">The history of the Project Laboratory (Témalabor) course</span>
...
Of course, over the past 25 years, a lot has changed. For example, in the early years, the topic proposals were not posted online, but Dr. Lázi put them in a folder at the library. Initially, the course was four semesters long, but after the transition to the Bologna system, it became a two-semester course. The popularity of topics has also changed significantly over the past 25 years. Dr. Lázi noted that while encryption and optimization used to be the most popular topics, nowadays topics related to network science and data science are the most popular.
          </p>
          <h3>However, the goal of the course has remained unchanged for 25 years. Dr. Lázi summarized why the subject was included in the curriculum from the beginning:</h3>
<p>•         Mathematics students should learn to communicate with non-mathematically trained professionals, and be able to participate in team work.</p>  <p>·         Students should become familiar with another, typically interdisciplinary field, its terminology, logic, and a current problem.</p>  
<p>•         They should be introduced to the concrete application of mathematics.</p>
<p>•         Students should become familiar with research work, literature review, creating work plans, and practicing the presentation of their work in writing and orally.</p>
<p>Dr. Lázi emphasized that the oral project reports are a very important part of the course, and she is very grateful to those professors who listened to the students' presentations, highlighting the active participation of Dr. János Tóth and Dr. Péter Prőhle. She recalled with pleasure those reports where an active intellectual discourse followed the presentations, often with the participation of the supervisors.</p>
