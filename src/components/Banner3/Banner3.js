...
import projectimage13 from "../../assets/img/p13.png";
import projectimage14 from "../../assets/img/p14.png";
...
<h8>Assistant Professor </h8><br/>
  ...
  <div>
The research topic aims to investigate the effects of positive psychological characteristics behind successful performance using mathematical methods. The primary area of research is the examination of predictions using machine learning methodology to
 filter out human attributes that influence performance. This kind of modelling of success enables optimal organizational human resource planning and development. The research area combines the results of the humanities with the field of data sciences using mathematical tools.
...
<h9> Applied Sciences</h9>, 11(4), 1744. </li><li>Richardson, M., Abraham, C., & Bond, R. (2012). Psychological correlates of university students' academic performance: a systematic review and meta-analysis. 
 ...
 <br/>
  ...
  <div>The aim of the research is to investigate the competitive processes in the Hungarian retail fuel market, what determines the prices at which certain petrol stations sell fuel
     (e.g. the number of other petrol stations nearby, the population of the settlement, the number of petrol stations on the motorway). The topicality of the topic is given by the fuel price freeze, 
     which was lifted in December 2022 after more than a year, as it is an interesting question to examine the competition in the reviving market. The data for the analysis can be obtained from https://holtankoljak.net/, which is also part of the exercise.
 ...
 <br/>
              <h8>Research Fellow <br/>Research Group of Operations Research and Decision Systems, SZTAKI</h8>
...
subject to some constraints. In the analysis and comparison of different tournament designs, both theoretical and simulation tools can be successfully applied.
 ...
 <br/>
              ...
              <ShowMoreText lines={1}>   
  <div>
The network structure of the corpus of Hungarian laws issued between 1990 and 2022 can be analysed in several ways. The internal structure of each law, the qualitative and quantitative characteristics of the laws, and the changes
 in the structure of the texts over time can be examined. Considering the laws as nodes, and the references among them as edges, the legal corpus as a network can be described and analysed based on network theory tools, with the help of various centrality measures.
 ...
 <br/>
              ...
              <ShowMoreText lines={1}>   
  <div>
The aim of the project is to develop a technique for identifying patterns in log data by dynamically clustering log anomalies in real-time. This method involves applying unsupervised machine learning 
algorithms to the real-time evolving data, which automatically group similar log anomalies together into clusters. By analyzing the patterns within these clusters, 
the method can identify potential issues or anomalies in the system and provide insights for optimization or troubleshooting. The approach is useful for monitoring 
large-scale distributed systems, such as those used in cloud computing or IoT devices, and can help improve system performance, reliability, and security.
...
<br/>
              ...
              <ShowMoreText lines={1}>   
  <div>
  The occurrence of tree species in high mountains usually ends abruptly at some elevation. This is the treeline. Magnifying this region, we find a characteristic ‘mainland/island’ structure, in which the tree cover is continuous at lower elevations 
  (‘mainland’), and gets fragmented at higher ones (‘islands’). Theoretical considerations from percolation theory suggest that the hull of the ‘mainland’ should be a fractal with dimension 7/4. 
   The task is to test this hypothesis using satellite images of treelines. The main goal is to suggest a feasible method for characterising the fractal structure of treelines, taking into account the limitations of real-life ecological data. 
   The method’s potential applications include the precise delineation of species borders, and thus the detection of population shifts due to climate change. <br/>
 ...
 <br/>
              <h8>Machine Learning Engineer<br/> Snapchat</h8>
             

              </Card.Text>
              <ShowMoreText lines={2}>   
  <div>
The project aims at developing a method to evaluate the impact of scientific research while accounting for the practice of citation manipulation or 'citation gaming.' Citation gaming involves
 authors manipulating citations to artificially boost their impact metrics. The proposed method should adjust the citation counts of articles based on the proportion of self-citations and citations 
 from suspect sources. This approach allows for a more accurate evaluation of the impact of research and can be useful for funding agencies, research institutions, and researchers themselves in assessing the value of scientific publications.
       <br/><br/>Related literature: <ul>
...
<br/>
  ...
  <div>Differential equations are frequently utilized in chemical engineering practice for process modeling and simulation that allows for evaluating the performance of chemical processes before the first real experiment and investment. In this context, process models will have a major role in the transition to cleaner and safer production, accelerating the adoption of fully circular economies. Unfortunately, the computational cost of these differential equations is prohibitive for many applications (despite the recent significant progress in information technology that includes parallel, 
    GPU, and cloud computing (Szilágyi & Nagy, 2016). It was shown recently that neural networks could be used to approximate the solution of differential equations describing fluid mechanics (Cai et al., 2021), 
    by incorporating the differential equation into the loss function. This study aims to extend the concept of physics-informed neural networks to general chemical engineering applications by solving representative case studies 
    for chemical and biochemical reactions and separation models. This work will pave the way for spreading digital solutions across all engineering fields.
  ...
  <br/><br/>Recommended literature: <ul>
    ...
    </li> <li>Szilágyi, B., & Nagy, Z. K. (2016). Graphical processing unit (GPU) acceleration for numerical solution of population balance models using high 
      resolution finite volume algorithm.<h9> Computers and Chemical Engineering</h9>, 91, 167–181. <a href="https://doi.org/10.1016/j.compchemeng.2016.03.023"> https://doi.org/10.1016/j.compchemeng.2016.03.023</a>
    </li></ul></div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
       ...
       <Container className="g-3">
        ...
        <Col>
          <Card  className="Card3"  bg="dark">
          {/* <Card.Title><h2>The impact of the Russia-Ukraine war and the energy crisis on the perception of nuclear energy</h2></Card.Title> */}
            <Card.Img variant="top" src={projectimage13} />

            <Card.Body >
              <Card.Text><img className="img2" src={projImg12}/> <h7>Dr. Attila Aszódi</h7>                
<br/>
              <h8>Professor, Dean<br/> Institute of Nuclear Techniques, BME</h8>
              ...
              <ShowMoreText lines={2}>   
  <div>The project will be co-supervised by Ildikó Boros. <br/>
In this project, students will analyze articles from news outlets, social media posts and memes about nuclear energy to investigate how the perception of nuclear energy has changed due to the Russia-Ukraine war and the energy crisis.
Students will use various data science techniques (such as topic analysis, sentiment analysis, optical character recognition, and object detection) to answer the following research questions:<br/>What was the perception of nuclear energy before the war and now?
Is there a difference between the perception of nuclear energy in the press of pro-nuclear and anti-nuclear countries? Has it changed due to the war?<br/> What factors
might play a role?<br/>
How is nuclear energy perceived in social media? Has it changed as a result of the war?

  <br/><br/>Related literature: <ul>
    <li>McMakin, A. H., & Lundgren, R. E. (2018). Risk communication: A handbook for communicating environmental, safety, and health risks. <h9>John Wiley & Sons.</h9>
    </li> <li>Bird, D. K., Haynes, K., van den Honert, R., McAneney, J., & Poortinga, W. (2014). Nuclear power in Australia: A comparative analysis of public opinion regarding climate change and the Fukushima disaster.<h9> Energy Policy</h9>, 65, 644-653.
    </li>
    <li>Corner, A., Venables, D., Spence, A., Poortinga, W., Demski, C., & Pidgeon, N. (2011). Nuclear power, climate change and energy security: Exploring British public attitudes.<h9> Energy Policy</h9>, 39(9), 4823-4833.</li>
    <li>Park, E. (2019). Positive or negative? Public perceptions of nuclear energy in South Korea: Evidence from Big Data.<h9> Nuclear Engineering and Technology</h9>, 51(2), 626-630.</li>
    <li>Khatua, A., Cambria, E., Ho, S. S., & Na, J. C. (2020, July). Deciphering public opinion of nuclear energy on Twitter. In<h9> 2020 International joint Conference on neural networks (IJCNN)</h9> (pp. 1-8). IEEE.</li>
    <li>Zarrabeitia-Bilbao, E., Jaca-Madariaga, M., Rio-Belver, R. M., & Álvarez-Meaza, I. (2023). Nuclear energy: Twitter data mining for social listening analysis.<h9> Social Network Analysis and Mining</h9>, 13(1), 29.</li>
    <li>Boumans, J. W., Vliegenthart, R., & Boomgaarden, H. G. (2016). Nuclear voices in the news: A comparison of source, news agency and newspaper content about nuclear energy over time.<h9> European Journal of Communication</h9> , 31(3), 260-282.</li>
    <li>Mercado-Sáez, M. T., Marco-Crespo, E., & Álvarez-Villa, À. (2019). Exploring news frames, sources and editorial lines on newspaper coverage of nuclear energy in Spain.<h9> Environmental Communication</h9>, 13(4), 546-559.</li>
    </ul></div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
        ...
        <Col>
          <Card  className="Card3"  bg="dark">
          {/* <Card.Title><h2>Analysis of high time resolution historical data of the European electricity system</h2></Card.Title> */}
            <Card.Img variant="top" src={projectimage14} />
...
<h8>Professor, Dean<br/> Institute of Nuclear Techniques, BME</h8>
              ...
              <ShowMoreText lines={2}>   
  <div>The project will be co-supervised by Bence Biró. <br/>
In this project, students will analyze hourly resolution data of the European Association for the Cooperation of Transmission System Operators (ENTSO-E). Students will use advanced statistical and machine learning tools to investigate the following research questions:<br/>

Processing of load change events of conventional power plants (nuclear, coal-fired, natural gas-fired, etc.)<br/>
Investigating the relationship between power decrease and increase events and electricity consumption<br/>
Investigating the relationship between load change events of conventional power plants and weather-dependent renewable energy production

  <br/><br/>Related literature: <ul>
    <li>Mayer, M. J., Biró, B., Szücs, B., & Aszódi, A. (2023). Probabilistic modeling of future electricity systems with high renewable energy penetration using machine learning. <h9> Applied Energy</h9>, 336, 120801.
    </li> 
    <li>Aszódi, A., Biró, B., Adorján, L., Dobos, Á. C., Illés, G., Tóth, N. K., ... & Zsiborás, Z. T. (2021). 
      Comparative analysis of national energy strategies of 19 European countries in light of the green deal’s objectives.<h9> Energy Conversion and Management</h9>: X, 12, 100136.
    </li>
    <li>Hirth, L., Mühlenpfordt, J., & Bulkeley, M. (2018). The ENTSO-E Transparency Platform–A review of Europe’s most ambitious electricity data platform.<h9> Applied Energy</h9>, 225, 1054-1067.</li>
    </ul></div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
