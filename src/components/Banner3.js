...
import projectimage1 from "../assets/img/p1.jpeg";
import projectimage2 from "../assets/img/p2.webp";
import projectimage3 from "../assets/img/p3.webp";
import projectimage4 from "../assets/img/p4.jpeg";
import projectimage5 from "../assets/img/p5.png";
import projectimage6 from "../assets/img/p6.jpeg";
import projectimage7 from "../assets/img/p7.webp";
import projectimage8 from "../assets/img/p8.jpeg";
import projectimage9 from "../assets/img/p9.webp";
import projectimage10 from "../assets/img/p10.webp";
import projectimage11 from "../assets/img/p11.jpg";
...
Applied Sciences, 11(4), 1744. </li><li>Richardson, M., Abraham, C., & Bond, R. (2012). Psychological correlates of university students' academic performance: a systematic review and meta-analysis. 
  Psychological bulletin, 138(2), 353. </li>
  <li>Martínez, I. M., Youssef-Morgan, C. M., Chambel, M. J., & Marques-Pinto, A. (2019). Antecedents of academic performance of university students: Academic engagement and psychological capital resources. Educational Psychology, 39(8), 1047-1067.
  </li></ul>
  </div></ShowMoreText>   
 ...
 <br/>
              <h8>Head of Economic and Market Research, Hungarian Competition Authority</h8>
  ...
  <br/><br/>Recommended literature: <ul><li>Fasoula, E., & Schweikert, K. (2020). Price regulations and price adjustment dynamics: Evidence from the Austrian retail fuel market. 
    Journal of Transport Economics and Policy (JTEP), 54(1), 21-39.</li>
    <li>Genakos, C., & Pagliero, M. (2022). Competition and pass-through: evidence from isolated markets. American Economic Journal: Applied Economics, 14(4), 35-57.</li>
    <li> Farkas, R., & Yontcheva, B. (2019). Price transmission in the presence of a vertically integrated dominant firm: Evidence from the gasoline market. Energy policy, 126, 223-237.</li>
    <li>Farkas, R., & Czigány, G. (2017). Az autópályák indirekt hatása a kiskereskedelmi benzinárakra. STATISZTIKAI SZEMLE, 95(3), 278-296.",</li>
  </ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
        ...
        <Col>
          <Card className="CARD2"  bg="dark">
          <Card.Title><h2>Tournament Design</h2>
          </Card.Title>
 ...
 <br/>
              <h8>Research Group of Operations. Research and Decision Systems, SZTAKI</h8>
...
subject to some constraints. In the analysis and comparison of different tournament designs, both theoretical and simulation tools can be successfully applied."  
 <br/><br/>Related literature: <ul>
  <li>Csató, L. (2021). Tournament Design: How Operations Research Can Improve Sports Rules. Palgrave Pivots in Sports Economics. Palgrave Macmillan, Cham, Switzerland.</li>
  <li>Kendall, G. and Lenten, L. J. A. (2017).  When sports rules go awry. European Journal of Operational Research, 257(2):377–394.</li>
  <li>Lenten, L. J. A. and Kendall, G. (2021). Scholarly sports: Influence of social science academe on sports rules and policy. Journal of the Operational Research Society, in press. DOI: 10.1080/01605682.2021.2000896.</li>  
  <li> Wright, M. (2009). 50 years of OR in sport. Journal of the Operational Research Society, 60(Supplement 1):S161–S168. </li>
  <li>Wright, M. (2014). OR analysis of sporting rules – A survey. European Journal of Operational Research, 232(1):1–8."</li>
   </ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
...
The network structure of the corpus of Hungarian laws issued between 1990 and 2022 can be analysed in several ways. The internal structure of each law, the qualitative and quantitative characteristics of the laws, and the changes in the structure of the texts over time can be examined. Considering the laws as nodes, and the references among them as edges, the legal corpus as a network can be described and analysed based on network theory tools, with the help of various centrality measures.",
        <br/><br/>Related literature: <ul><li>Fowler, J. H., Johnson, T. R., Spriggs II, J. F., Jeon, S., & Wahlbeck, P. J. (2007). Network analysis and the law: Measuring the legal importance of 
          Supreme Court precedents. Political Analysis, 15(3), 324-346. </li>
          <li>Whalen, R. (2016). Legal networks: The promises and challenges of legal network analysis. Mich. St. L. Rev., 539.", </li>
        </ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
...
<br/><br/>Related literature: <ul><li>Landauer, M., Wurzenberger, M., Skopik, F., Settanni, G., & Filzmoser, P. (2018). 
  Dynamic log file analysis: An unsupervised cluster evolution approach for anomaly detection. Computers & Security, 79, 94-116.</li>
  <li>Christensen, R., & Li, F. (2013, June). Adaptive log compression for massive log data. In SIGMOD Conference (pp. 1283-1284). </li>
  <li>He, S., He, P., Chen, Z., Yang, T., Su, Y., & Lyu, M. R. (2021). A survey on automated log analysis for reliability engineering. ACM computing surveys (CSUR), 54(6), 1-37.</li>
  <li>Landauer, M., Skopik, F., Wurzenberger, M., & Rauber, A. (2020). System log clustering approaches for cyber security applications: A survey. Computers & Security, 92, 101739. ",</li>
</ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
...
<br/>
  ...
  <br/>Related literature: <ul><li>Gastner, M., Oborny, B., Pruessner, G. & Zimmermann, D. (2009) Transition from connected to fragmented vegetation across an environmental gradient: scaling laws in ecotone geometry. 
    American Naturalist 174: 23-39. </li><br/> <li>Juhász R., Oborny B. (2020) Percolation theory suggests some universal features in range margins across environmental gradients. Ecological Complexity 42, 100814.  ",
  </li>  </ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
 ...
 <br/>
              <h8>Machine Learning Engineer, DAALab</h8>
...
The project aims at developing a method to evaluate the impact of scientific research while accounting for the practice of citation manipulation or 'citation gaming.' Citation gaming involves authors manipulating citations to artificially boost their impact metrics. The proposed method should adjust the citation counts of articles based on the proportion of self-citations and citations from suspect sources. This approach allows for a more accurate evaluation of the impact of research and can be useful for funding agencies, research institutions, and researchers themselves in assessing the value of scientific publications.",
       ...
       <li>Chakraborty, J., Pradhan, D. K., & Nandi, S. (2022). Research misconduct and citation gaming: A critical review on characterization and recent trends of research manipulation.
              Data Management, Analytics and Innovation: Proceedings of ICDMAI 2021, Volume 2, 485-492.</li> 
              <li> Fister Jr, I., Fister, I., & Perc, M. (2016). Toward the discovery of citation cartels in citation networks. Frontiers in Physics, 4, 49.</li> 
              <li> Senanayake, U., Piraveenan, M., & Zomaya, A. (2015). The pagerank-index: Going beyond citation counts in quantifying scientific impact of researchers. PloS one, 10(8), e0134794.</li> 
              <li> Gao, C., Wang, Z., Li, X., Zhang, Z., & Zeng, W. (2016). PR-index: using the h-index and PageRank for determining true impact. PloS one, 11(9), e0161755.</li> 
              ...
              Journal of Korean Medical Science, 33(18).</li> 
              <li>  Bai, X., Pan, H., Hou, J., Guo, T., Lee, I., & Xia, F. (2020). Quantifying success in science: An overview. IEEE Access, 8, 123200-123214.</li> 
              <li> Vergoulis, T., Kanellos, I., Atzori, C., Mannocci, A., Chatzopoulos, S., Bruzzo, S. L., ... & Manghi, P. (2021, April). Bip! db: A dataset of impact measures for scientific publications. In Companion Proceedings of the Web Conference 2021 (pp. 456-460).",
         </li>  </ul>
  </div>
  </ShowMoreText>   
            </Card.Body>
...
<li>Rogers EM (1962) Diffusion of innovations, 1st ed. Free Press of Glencoe, New York</li>
<li>Kempe D, Kleinberg J, Tardos E (2003) Maximizing the spread of influence through a social network. In: Proceedings of the 9th ACM SIGKDD international conference on knowledge discovery and data mining, KDD ’03, Association for Computing Machinery, New York, NY, USA, pp 137–146
</li><li>Sziklai BR (2018) How to identify experts in a community? Int J Game Theory 47:155–173</li>
<li>Sziklai BR and Lengyel B (2023) Finding early adopters of innovation in social networks Social</li>
<li>Network Analysis and Mining 13:4</li>
</ul> </div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
...
<br/>
              <h8>Rector's delegate. Rector's Office, Directorate of Education, BME</h8>
...
<li>Ozsogomonyan, A., & Loftus, D. (1979). Predictors of general chemistry grades. Journal of Chemical Education, 56(3), 173. </li>

<li>Daniel House, J. (1995). Noncognitive predictors of achievement in introductory college chemistry. Research in Higher Education, 36, 473-490. </li>

<li>Wagner, E. P., Sasser, H., & DiBiase, W. J. (2002). Predicting students at risk in general chemistry using pre-semester assessments and demographic information. Journal of Chemical Education, 79(6), 749. </li>

<li>Lopez, E. J., Shavelson, R. J., Nandagopal, K., Szu, E., & Penn, J. (2014). Factors contributing to problem-solving performance in first-semester organic chemistry. Journal of Chemical Education, 91(7), 976-981. </li>

<li>Fink, A., Frey, R. F., & Solomon, E. D. (2020). Belonging in general chemistry predicts first-year undergraduates’ performance and attrition. Chemistry Education Research and Practice, 21(4), 1042-1062. </li>

<li>Kiss, B., Nagy, M., Molontay, R., & Csabay, B. (2019, November). Predicting dropout using high school and first-semester academic achievement measures. In 2019 17th international conference on emerging eLearning technologies and applications (ICETA) (pp. 383-389). IEEE. </li>

<li>Baranyi, M., Gál, K., Molontay, R., & Szabó, M. (2019, November). Modeling students’ academic performance using Bayesian networks. In 2019 17th international conference on emerging eLearning technologies and applications (ICETA) (pp. 42-49). IEEE. </li>

<li>Baranyi, M., Nagy, M., & Molontay, R. (2020, October). Interpretable deep learning for university dropout prediction. In Proceedings of the 21st annual conference on information technology education (pp. 13-19). </li>
...
<br/><br/>Related literature: <ul>
  <li>Lies, J., & Fuß, S. (2019). Factors influencing the success of social media posts: A quantitative analysis of over 60 million Facebook posts. Journal of Digital & Social Media Marketing, 7(2), 137-147.
...
<br/>
              <h8>Dean. Budapest Metropolitan University</h8>
...
<li>McPherson, M., Smith-Lovin, L. and Cook, J.M. (2001). Birds of a Feather: Homophily in Social Networks. Annu. Rev. Sociol. 2001. 27:415–44. </li>

<li>Marshall, D. (2010). Who to lobby and when: Institutional determinants of interest group strategies in European Parliament committees. European Union Politics. 11(4) 553–575. </li>

<li>Hix, S., Noury, A. and Roland, G. (2009). Voting patterns and alliance formation in the European Parliament. Phil. Trans. R. Soc. B. 364, 821–831. </li>

<li>Kreppel, A. (1999). What Affects the European Parliament’s Legislative Influence? An Analysis of the Success of EP Amendments. Journal of Common Market Studies. 37(3): 521–38. </li>

<li>Fertő, I., Kóczy, L.Á., Kovács, A. and Sziklai, B.R. (2020). The power ranking of the members of the Agricultural Committee of the European Parliament. European Review of Agricultural Economics. 47(5): 1897–1919
</li></ul></div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
...
<br/>
  ...
  <br/><br/>Recommended literature: <ul>
    <li>Cai, S., Mao, Z., Wang, Z., Yin, M., & Karniadakis, G. E. (2021). Physics-informed neural networks (PINNs) for fluid mechanics: a review. Acta Mechanica Sinica, 37(12), 1727–1738. https://doi.org/10.1007/s10409-021-01148-1
    </li> <li>Szilágyi, B., & Nagy, Z. K. (2016). Graphical processing unit (GPU) acceleration for numerical solution of population balance models using high resolution finite volume algorithm. Computers and Chemical Engineering, 91, 167–181. https://doi.org/10.1016/j.compchemeng.2016.03.023
    </li></ul></div>
  </ShowMoreText>   
            </Card.Body>
          </Card>
